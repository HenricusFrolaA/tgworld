...
<body>
  ...
  <div id="wrapper" class="wrapper-container">
    ...
    <header id="header">
      ...
      <div class="top-header flex-row flex-justify flex-center">
        ...
        <div class="logo-wrap">
          ...
          <a href="index.html" class="logo"><img src="images/logo/logo_tsp.png" height="100px" alt=""></a>
            ...
            <div class="nav-item">
              ...
              <nav id="main-navigation" class="main-navigation">
                <ul id="menu" class="clearfix">
                  ...
                  <li class="current dropdown has-megamenu"><a href="#">Pages</a>
                    <!--sub menu-->
              ...
              <div class="contact-info-item">
                ...
                <div class="flex-row flex-center">
                  ...
                  <div class="item-inner">
                    ...
                    <a href="callto:#"><b>+255 27 254 6146</b></a>
                  </div>
    ...
    <div id="content">
      ...
      <div class="breadcrumbs-wrap" data-bg="images/1920x200_img1.jpg">
            ...
            <div class="col-md-12">
              <fieldset>
                <div class="blue-button">
                    ...
                    <button type="submit" name="send_email" ><a id="form-submit" class="btn">Send Message</a></button>
      ...
      <div class="copyright-section">
        ...
        <div class="container">
          ...
          <div class="flex-row flex-justify flex-center">
            ...
            <div class="copyright">Copyright tg world © 2018. All Rights Reserved.</div>
